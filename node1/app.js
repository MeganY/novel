...
var index = require('./routes/index');//创建路由
...
var app = express();
var viewNovelSection = require('./routes/viewNovelSection');
...
app.use('/',index);
app.use('/install',install);//引入路由中间件
app.use('/ajax/admins',admins);
app.use('/test',test);
app.use('/viewnovel',viewnovel);
app.use('/viewNovelSection',viewNovelSection);
